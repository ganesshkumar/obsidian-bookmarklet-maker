      ...
      <div className='container mx-auto'>
        ...
        <div className='flex-col min-h-screen justify-around'>
          <div className='mt-5 mb-10'>
            <h1 className="text-3xl text-center font-bold text-purple-700"> Obsidian Clipper Maker </h1>
            <h2 className='text-center text-slate-400 italic'> Make your own Obsidian Clipper</h2>
          </div>
          <div className='flex'>
            <div className='flex-col mx-5 lg:w-1/3'>
              <div className='my-5'>
                <label htmlFor='title'>Clipper Name</label>
                <input
                    type='text'
                    name='title'
                    onChange={e => this.setState({title: e.target.value})}
                    className="my-2 placeholder:italic placeholder:text-slate-400 block bg-white border border-slate-300 rounded-md py-2 pl-3 pr-3 shadow-sm focus:outline-none focus:border-purple-500 focus:ring-purple-500 focus:ring-1 sm:text-sm"
              ...
              <div className='my-5 flex'>
                <button 
                    ...
                    className='px-4 py-1 text-sm text-white font-semibold rounded border bg-purple-700 hover:text-white hover:bg-purple-700 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2 rop-shadow-md'>
                  Generate
                </button>
              </div>
            </div>
            <div className='flex-col mx-5 my-5 lg:w-2/3'>
              ...
              <textarea disabled 
                  placeholder='Generated javascript code appear here'
                  className='mt-2 px-3 w-full placeholder:italic placeholder:text-slate-400 border border-slate-300 rounded-md focus:outline-none focus:border-purple-500 focus:ring-purple-500 focus:ring-1'
              ...
              <textarea disabled 
                  placeholder='Generated HTML code appear here'
                  className='mt-2 px-3 w-full placeholder:italic placeholder:text-slate-400 border border-slate-300 rounded-md focus:outline-none focus:border-purple-500 focus:ring-purple-500 focus:ring-1'
          ...
          <div className='my-10 flex justify-center content-center text-xs text-slate-400'>
            <div>Created by <a href='https://twitter.com/ganesshkumar' rel='noreferrer' target='_blank'>ganesshkumar</a> | </div>
            <div>
              &nbsp;
              <a href='https://github.com/ganesshkumar/obsidian-bookmarklet-maker' rel='noreferrer' target='_blank'>Github</a> | 
            </div>
            <div>
              &nbsp;
...
function generateBookmarklet (title: string, vault: string, folder: string, tags: string): string[] {
  ...
  jsCode = jsCode.replace('TAGS', tags);
